...
type ChainInfo = ReturnType<typeof defineChainInfo>;

let neutronSimTestnet: ChainInfo | undefined = undefined;
// if this is provided, add it to the list of chains
if (NEUTRON_SIM_TESTNET_RPC_URL) {
  neutronSimTestnet = defineChainInfo({
...
export const allSupportedCosmosChains = [
  neutron,
  ...(neutronSimTestnet ? [neutronSimTestnet] : []),
];
